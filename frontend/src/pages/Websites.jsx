...
//     category: "Digital",
//     description:
//       "Digital marketing and technology company helping businesses grow through branding, marketing and web development.",
//     features: [
//       "Website development",
//       "Digital marketing",
...
//     category: "Media",
//     description:
//       "Creative poetry and literature platform where writers share their thoughts, stories and artistic expression.",
//     features: [
//       "Poetry collection",
...
//     category: "Media",
//     description:
//       "Live events platform organizing stand-up comedy shows, poetry nights, music performances and open mic sessions.",
//     features: [
...
//     logo: eventsLogo,
//     logoStyle: { width: "100px", height: "100px" },
//     buttonText: "Watch Channel ▶", // 👈 custom text
//   },
...
//     category: "Transport",
//     description:
//       "Logistics and transport coordination platform connecting businesses with reliable transportation and supply chain support.",
//     features: [
...
//   return (
//     <div className="min-h-screen bg-[#171123] text-[#EDE8F5] pt-28 px-4 sm:px-6 lg:px-10">
...
//             ${
//               filter === cat
//                 ? "bg-[#A663CC] text-white shadow-[0_0_20px_rgba(166,99,204,0.4)]"
//                 : "bg-[#221832] text-[#EDE8F580] hover:bg-[#2a1c3d]"
//             }`}
//           >
//             {cat}
//           </button>
...
//           <div
//             key={site.id}
//             className="bg-[#221832] border border-[#A663CC33] rounded-2xl p-6 flex flex-col items-center text-center transition hover:-translate-y-2 hover:border-[#A663CC80] shadow-lg"
//           >
//             {/* Logo */}
//             <div className="w-24 h-24 rounded-full bg-[#171123] flex items-center justify-center mb-4 shadow-[0_0_20px_rgba(166,99,204,0.3)] overflow-hidden">
//               <img
//                 src={site.logo}
//                 alt={site.name}
...
//             {/* Description */}
//             <p className="text-sm text-[#EDE8F580] mb-4">
//               {site.description}
//             </p>

//             {/* Features */}
//             <ul className="text-sm text-[#EDE8F580] space-y-1 mb-6 text-left w-full">
//               {site.features.map((feature, index) => (
//                 <li key={index} className="flex gap-2">
//                   <span className="text-[#A663CC]">•</span>
//                   {feature}
//                 </li>
//               ))}
//             </ul>
...
//               <Link
//                 to={site.page}
//                 className="flex-1 text-center bg-[#2a1c3d] text-white px-4 py-2 rounded-full text-sm hover:bg-[#3a2550] transition"
//               >
//                 View Details
//               </Link>
...
//                   target="_blank"
//                   rel="noreferrer"
//                   className="flex-1 text-center bg-[#A663CC] text-white px-4 py-2 rounded-full text-sm font-medium hover:bg-[#BC80D9] transition shadow-[0_0_20px_rgba(166,99,204,0.3)]"
//                 >
//                   {site.buttonText || "Visit Website"}
//                 </a>
//               )}
//             </div>
//           </div>
