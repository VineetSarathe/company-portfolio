...
//   return (
//     <div className="bg-white/40 backdrop-blur-md border border-teal-100/40 rounded-2xl shadow-lg hover:scale-105 transition-transform duration-300 p-4 sm:p-6 flex flex-col">

//       {/* Preview */}
//       <div className="aspect-video bg-teal-100 rounded-md mb-3 sm:mb-4 flex items-center justify-center">
//         <span className="text-sm sm:text-base text-teal-400">Preview</span>
//       </div>
...
//       {/* Description */}
//       <p className="text-xs sm:text-sm text-slate-600 flex-grow">
//         {description}
//       </p>
...
//         <Link
//           to={page}
//           className="flex-1 text-center bg-slate-200 text-slate-700 px-4 py-2 rounded-full text-xs sm:text-sm hover:bg-slate-300 transition"
//         >
//           Details
//         </Link>
...
//           target="_blank"
//           rel="noreferrer"
//           className="flex-1 text-center bg-teal-600 text-white px-4 py-2 rounded-full text-xs sm:text-sm shadow hover:bg-teal-700 transition"
//         >
//           Visit
//         </a>
